...
public class Variables_for_ConsumerPassword_CRU_Test
{
    ...
    public static List<Checker> checkers_for_restoreConsumerPass(String email, String newpass, String existedKey)
    {
        ...
        list.addAll(List.of(
                ...
                Checker.of("success", false, Map.of("newpass", newpass, "key", "123", "email", "lllgyg_bnmkksk12345llogygyg_bnmkkskslwlwll@gmail.com"), 200, "details", "email", "length must be less than or equal to 50"),
