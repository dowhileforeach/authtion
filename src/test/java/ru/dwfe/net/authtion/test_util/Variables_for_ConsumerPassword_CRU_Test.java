...
public class Variables_for_ConsumerPassword_CRU_Test
{
    ...
    public static final List<Checker> checkers_for_reqRestoreConsumerPass = List.of(
            Checker.of("success", false, Map.of(),                        200, "details", "email", "required field"),
            Checker.of("success", false, Map.of("email", ""),             200, "details", "email", "can't be empty"),
    ...
    public static List<Checker> checkers_for_confirmRestoreConsumerPass(String existedKey)
    {
        return List.of(
                Checker.of(null,      null,  Map.of(),                  400, null,      "message", "Required String parameter 'key' is not present"),
                Checker.of("success", false, Map.of("key", ""),         200, "details", "error",   "can't be empty"),
                Checker.of("success", false, Map.of("key", "657"),      200, "details", "error",   "key does not exist"),
                Checker.of("success", true,  Map.of("key", existedKey), 200, Map.of("email", EMAIL_NEW_Consumer, "key",existedKey))
        );
    }

    public static List<Checker> checkers_for_restoreConsumerPass(String existedKey)
    {
        List<Checker> list = new ArrayList<>(List.of(
        ...
        list.addAll(List.of(
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer),           200, "details", "key", "required field"),
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key",""), 200, "details", "key", "can't be empty")
        ));
        list.addAll(List.of(
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key","123"),                              200, "details", "email", "required field"),
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key","123", "email",""),                  200, "details", "email", "can't be empty"),
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key","123", "email","lllgyg_bnmkksk12345llogygyg_bnmkkskslwlwll@gmail.com"), 200, "details", "email", "length must be less than 50 characters"),
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key","123", "email","shop"),              200, "details", "email", "must be valid e-mail address"),
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key","123", "email","..puqu@mail.ru"),    200, "details", "email", "must be valid e-mail address"),
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key","123", "email","ehlo@mail.ru"),      200, "details", "error", "key does not exist"),
                Checker.of("success", false, Map.of("newpass", PASS_NEW_Consumer, "key",existedKey, "email","ehlo@mail.ru"), 200, "details", "error", "email from request doesn't match with email associated with key"),
                Checker.of("success", true,  Map.of("newpass", PASS_NEW_Consumer, "key",existedKey, "email", EMAIL_NEW_Consumer), 200)
        ));
        return list;
    }
}